...
rho_matrix = np.array([[0.8, 0.5, 0.2], [0.4, 0.7, 0.05], [0.2, 0.01, 0.6]])
num_CAVI_its = 25
num_mc = 10000
lr_theta = 0.5
lr_sigma = 0.1
...
means = [
    ...
    [0, 0, 0], # Mean for group 2
    [-5, -5, -5]  # Mean for group 3
]
covariances = [
    [[1, 0, 0], 
     [0, 1, 0], 
...
VB.run_VB_scheme(n_CAVI_its=num_CAVI_its, num_mc=num_mc, 
                 ...
                 max_ELBO_phi_dec=max_ELBO_phi_dec, max_ELBO_dec=max_ELBO_dec,
...
save_to_pickle(VB.phi_w_best, f'output_uni/phi_w/phi_w_{array_index}.pkl')
save_to_pickle(VB.phi_z_best, f'output_uni/phi_z/phi_z_{array_index}.pkl')
save_to_pickle(VB.alpha_rho_best, f'output_uni/alpha_rho/alpha_rho_{array_index}.pkl')
save_to_pickle(VB.beta_rho_best, f'output_uni/beta_rho/beta_rho_{array_index}.pkl')

save_to_pickle(VB.ELBO_store_full, f'output_uni/ELBO/ELBO_full_{array_index}.pkl')

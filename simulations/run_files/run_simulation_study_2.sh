...
SIMULATION_DIR="${PARENT_DIR}/simulation_2"
...
for ARRAY_ID in {0..5}; do
    ...
    echo "Running generate_layer_groups_2.py..."
    python3 -u "${SIMULATION_DIR}/generate_layer_groups_2.py" --index ${ARRAY_ID} > "${OUTPUT_DIR}/progress_output/generate_layer_groups_${ARRAY_ID}.out" 2> "${OUTPUT_DIR}/e_files/generate_error_${ARRAY_ID}.log"
    
    echo "Running simulation_2.py..."
    python3 -u "${SIMULATION_DIR}/simulation_2.py" --index ${ARRAY_ID} > "${OUTPUT_DIR}/progress_output/simulation_2_output_${ARRAY_ID}.out" 2> "${OUTPUT_DIR}/e_files/simulation_error_${ARRAY_ID}.log"
